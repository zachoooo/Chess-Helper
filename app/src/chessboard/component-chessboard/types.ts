import { AnyFunction, TArea, TPiece } from "../../types";
...
export interface IPremoveManager {
  cancel: AnyFunction;
  consumeNext: AnyFunction;
  getLegalMoves: () => IMove[];
  getLegalMovesForSquare: AnyFunction;
  getMove: AnyFunction;
  getPieces: AnyFunction;
  getQueue: AnyFunction;
  isLegalMove: AnyFunction;
  loadQueue: AnyFunction;
